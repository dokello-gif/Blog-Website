...
const SEO = ({ title, description, keywords, image, url }) => {
    ...
    // Generate dynamic image URL or use default
    // Note: logo.jpg should be in the public folder
    const ogImage = image ? urlFor(image).width(1200).height(630).url() : '/logo.jpg';
